...
export function OptimizeDiffDialog({ original, draft, scope, targetIndex, onApply, onClose }) {
  ...
  return <Modal open={Boolean(draft)} width={960} title="确认 AI 优化结果" onCancel={onClose} footer={<><Button onClick={onClose}>保留当前简历</Button><Button type="primary" disabled={!hasChanges} onClick={onApply}>应用优化结果</Button></>}>
